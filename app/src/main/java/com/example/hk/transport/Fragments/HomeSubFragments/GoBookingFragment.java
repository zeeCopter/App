...
public class GoBookingFragment extends Fragment{

    public static GoBookingFragment goBookingFragment;

    MapView mMapView;
    private GoogleMap googleMap;
    Button startBtn;

    public static GoBookingFragment getInstance() {
        if (goBookingFragment == null)
            return new GoBookingFragment();
        else
            return goBookingFragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_go_booking, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((MasterActivity)getActivity()).changeTitle("GO BOOKING");
